...
const Homepage = () => {
  ...
  const handleLikeProduct = (product) => {
    setPromptMessage(`${product.id} has been liked!`);
    setShowPrompt(true);
    setTimeout(() => setShowPrompt(false), 3000);
  };
      ...
      <div className="homepage">
        <div className='contain'>
          <div className='left'>
            ...
            <p className='PC'>Shop online, save time, and enjoy convenient <br />
              delivery same day fast reliable and fresh <br />
              delivery for all your daily needs.
            </p>
            <p className='mobile'>Shop online, save time, and enjoy <br />
              convenient delivery same day fast <br />
              reliable and fresh delivery for all your <br />
              daily needs.
            </p>
            <div className='button btnrr'>
          ...
          <div className='right-img'>
            <img src='../assets/Girl pic.svg' alt='girl-pic' className='PC-view-1'></img>
            <img src='../assets/girl pic phone.svg' alt='girl-pic' className='girl-pic'></img>
          </div>
          {/* <ChatbotToggle /> */}
        </div>
        ...
        <div className='categories'>
          ...
          <div className='bottom-text'>
            <p className='PC-view-2'>Shop online, save time, and enjoy convenient delivery same day fast <br />
              reliable and fresh delivery for all your daily needs.</p>

            <p className='mobile-view2'>Shop online, save time, and enjoy <br /> 
              convenient delivery same day fast reliable <br/>
              and fresh delivery for all your daily needs.</p>
          </div>
