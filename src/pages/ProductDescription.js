...
const ProductDescription = () => {
  ...
  return (
    <div className="product-description-container">
      <div className="head1">
        <Link to={`/pages/ProductPage`} className='link'>
          <button><GoChevronLeft className='arrow-left' /> Back</button>
        </Link>
      </div>
      ...
      <div className='contents'>
        <div className='text'>
          ...
          <div className='des-btns'>
            <button className='cart2' onClick={handleAddToCart}>Add to Cart</button>
